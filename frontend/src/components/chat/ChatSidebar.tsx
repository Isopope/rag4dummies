  ...
  return (
    <div className="flex flex-col h-full bg-sidebar text-sidebar-foreground">
      ...
      <div className="p-3 border-b border-sidebar-border">
        <button
          onClick={onNewSession}
          className="w-full flex items-center gap-2 px-3 py-2.5 rounded-xl bg-primary text-primary-foreground hover:opacity-90 transition-opacity text-sm font-semibold shadow-sm"
        >
          <Pencil className="w-4 h-4" />
