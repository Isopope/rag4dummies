...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex flex-col justify-between w-[45%] px-16 py-14 relative overflow-hidden bg-gradient-to-br from-brand-navy to-brand-navy-deep">
        <div
        ...
        <div className="relative z-10 space-y-8">
          ...
          <h2 className="font-display font-light text-white text-5xl leading-[1.05] tracking-tight">
            Créez votre<br />
            espace<br />
            <em className="not-italic text-brand-orange">documentaire</em><br />
            souverain.
          </h2>
          ...
          <svg viewBox="0 0 280 180" fill="none" className="w-64 opacity-90" aria-hidden="true">
            ...
            <circle cx="60" cy="44" r="2.5" fill="hsl(var(--brand-orange))" fillOpacity="0.9" />
